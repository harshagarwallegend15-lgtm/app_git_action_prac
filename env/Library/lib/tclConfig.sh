...
# installed.
TCL_PREFIX='C:/git action practice/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/git action practice/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/git action practice/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/git action practice/env\Library\include'
...
TCL_PACKAGE_PATH='C:/git action practice/env\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/git action practice/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/git action practice/env\Library\lib\tclstub86.lib'
